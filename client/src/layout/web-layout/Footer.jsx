...
const Footer = () => {
  return (
    <footer className="bg-blue-gray-50 text-center lg:text-left mt-24">
      <div className="flex items-center justify-center border-border p-6 lg:justify-between">
        ...
        <div className="flex gap-6 items-center justify-center">
          {socials.map((social, index) => (
            <a href={social?.to} target='_blank' key={index} className='rounded-full hover:text-primary cursor-pointer'>{social.icon}</a>
          ))}
        </div>
      </div>
      <Hrz />
