...
const Footer = () => {
  return (
    <footer className="text-center lg:text-left mt-24" style={{ background: 'linear-gradient(to bottom, #ffffff 30%, #fff6aa 100%)' }}>
      <div className="flex items-center justify-center border-border p-6 lg:justify-between">
        ...
        <div className="flex gap-6 items-center justify-center">
          {socials.map((social, index) => (
            <a href={social?.to} target="_blank" key={index} className="rounded-full hover:text-primary cursor-pointer">
              {social.icon}
            </a>
          ))}
        </div>
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <Logo classNameImg="md:h-24 h-12" />
          ...
          <div className="flex flex-col gap-3">
            <h6 className="mb-4 flex justify-center font-semibold uppercase md:justify-start">Chính sách</h6>
            {policies.map((policy) => (
